    ...
    for step, batch in enumerate(train_dataloader):
        ...
        if global_step % args.num_save_steps == 0:
            if args.local_rank in [-1, 0] and args.num_save_steps > 0:
                ...
                output_dir = args.output_dir / f'lm-checkpoint'
...
'''
06/21/2020 17:26:23 - INFO - model.configuration_utils -   Model config {
 ...
 param size bert.embeddings.word_embeddings.weight-->torch.Size([21128, 128]) 
 param size bert.embeddings.position_embeddings.weight-->torch.Size([512, 128]) 
 param size bert.embeddings.token_type_embeddings.weight-->torch.Size([2, 128]) 
 param size bert.embeddings.LayerNorm.weight-->torch.Size([128]) 
 param size bert.embeddings.LayerNorm.bias-->torch.Size([128]) 
 param size bert.encoder.embedding_hidden_mapping_in.weight-->torch.Size([768, 128]) 
 param size bert.encoder.embedding_hidden_mapping_in.bias-->torch.Size([768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.attention.self.query.weight-->torch.Size([768, 768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.attention.self.query.bias-->torch.Size([768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.attention.self.key.weight-->torch.Size([768, 768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.attention.self.key.bias-->torch.Size([768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.attention.self.value.weight-->torch.Size([768, 768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.attention.self.value.bias-->torch.Size([768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.attention.output.dense.weight-->torch.Size([768, 768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.attention.output.dense.bias-->torch.Size([768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.ffn.intermediate.dense.weight-->torch.Size([3072, 768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.ffn.intermediate.dense.bias-->torch.Size([3072]) 
 param size bert.encoder.transformer.group.0.inner_group.0.ffn.intermediate.output.dense.weight-->torch.Size([768, 3072]) 
 param size bert.encoder.transformer.group.0.inner_group.0.ffn.intermediate.output.dense.bias-->torch.Size([768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.LayerNorm.weight-->torch.Size([768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.LayerNorm.bias-->torch.Size([768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.LayerNorm_1.weight-->torch.Size([768]) 
 param size bert.encoder.transformer.group.0.inner_group.0.LayerNorm_1.bias-->torch.Size([768]) 
 param size bert.pooler.dense.weight-->torch.Size([768, 768]) 
 param size bert.pooler.dense.bias-->torch.Size([768]) 
 param size cls.predictions.bias-->torch.Size([21128]) 
 param size cls.predictions.transform.dense.weight-->torch.Size([128, 768]) 
 param size cls.predictions.transform.dense.bias-->torch.Size([128]) 
 param size cls.predictions.transform.LayerNorm.weight-->torch.Size([128]) 
 param size cls.predictions.transform.LayerNorm.bias-->torch.Size([128]) 
 param size cls.seq_relationship.weight-->torch.Size([2, 768]) 
 param size cls.seq_relationship.bias-->torch.Size([2]) 
'''